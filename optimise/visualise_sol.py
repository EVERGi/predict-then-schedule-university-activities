...
def visualise_activities(solutions, base_load, prices, recur_info, once_off_info, monday_index, bat_sols, batt_info, save_fig = False):
    # print(base_load)
    ...
    all_9am_lines = [monday_index+9*4+i*24*4-0.5  for i in range(30) if i%7 <5]

    all_17pm_lines = [monday_index+17*4+(i-1)*24*4-0.5 for i in range(30)if 0<i%7<6]
